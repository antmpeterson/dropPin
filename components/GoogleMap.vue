...
<ol type = "1">
  ...
  <li> Once the pin is where you like click the "Click to find out!" this will display your address and correspoding coordinates.</li>
</ol> 
  </div>
   <div>
    <h2> Your selected location is: </h2>
    <button v-on:click="say('what')">Click to find out!</button>
  </div>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    navigator.geolocation.getCurrentPosition(
      position => alert(`Lat: ${position.coords.latitude} Lng: ${position.coords.longitude}`),
